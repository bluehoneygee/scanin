...
3) "awareness": 2-3 kalimat edukasi
   ...
   - Jelaskan bisa dipakai ulang untuk apa (wadah, pot, kerajinan, organizer)
   - Baru sebutkan apakah bisa didaur ulang atau tidak
...
4) "tips": 5-7 ide PENGGUNAAN ULANG yang spesifik & kreatif:
   - PRIORITAS: cara pakai ulang produk/kemasannya (bukan cara buang)
   - Format: "Jadikan [fungsi baru] untuk [kegunaan spesifik di rumah]"
   - Contoh BAGUS: 
     * "Jadikan pot tanaman cabai di dapur"
     * "Simpan bumbu kering dalam botol bekas shampo"
     * "Gunakan kardus jadi rak sepatu di kamar"
     * "Potong jadi alas piring di kulkas"
   - Contoh JELEK (terlalu umum): 
     * "Buat kerajinan tangan" ❌
     * "Untuk dekorasi" ❌
     * "Manfaatkan kembali" ❌
   - Jika memang TIDAK bisa dipakai ulang, baru kasih tips pembuangan yang benar
   - Maksimal 80 karakter per poin
   - Sebutkan lokasi rumah: dapur/kamar/teras/garasi/kamar mandi

KONSISTENSI WAJIB:
- Jika awareness bilang "bisa dipakai ulang", tips WAJIB kasih ide konkret (min 3 ide)
- Jika awareness bilang "tidak bisa dipakai ulang", tips fokus ke pembuangan/daur ulang
- Recyclable = false → jangan anjurkan daur ulang di tips
