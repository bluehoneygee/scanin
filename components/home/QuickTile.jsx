...
export default function QuickTile({ title, badge, iconPath }) {
  return (
    <div className="relative flex items-center justify-between rounded-2xl border border-neutral-200 bg-white p-3 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
