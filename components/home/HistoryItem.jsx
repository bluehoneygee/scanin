...
export default function HistoryItem({ title, timestamp, chipLabel }) {
  return (
    <li className="flex items-center justify-between rounded-xl border border-neutral-200 bg-white p-3 text-sm shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
      <div className="flex items-center gap-3">
        <div className="h-10 w-10 rounded-lg bg-neutral-100 ring-1 ring-neutral-200 dark:bg-neutral-800 dark:ring-neutral-700" />
        <div>
