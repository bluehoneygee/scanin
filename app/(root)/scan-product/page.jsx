...
export default function ScanProductPage() {
  ...
  const userId = auth?.id || auth?.username || auth?.email || "";
  return (
    <>
      <div className="min-h-dvh w-full overflow-x-hidden bg-neutral-50 text-neutral-900 dark:bg-neutral-950 dark:text-neutral-50">
        <header className="sticky top-0 z-40">
          <div className="relative left-1/2 -ml-[50vw] w-[100vw] -mr-[50vw] border-b border-neutral-200 bg-white/90 pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)] backdrop-blur dark:border-neutral-800 dark:bg-neutral-900/80">
            <div className="mx-auto max-w-3xl px-4 py-3 flex items-center gap-3 lg:hidden">
              <Link
                href="/"
        ...
        {!userId ? (
          <main className="mx-auto max-w-sm md:max-w-3xl px-4 md:px-6 py-10">
            <Alert>
              <AlertTitle>Butuh login</AlertTitle>
              <AlertDescription className="text-sm">
                Silakan masuk terlebih dulu untuk menyimpan hasil scan ke
                akunmu.
              </AlertDescription>
            </Alert>
          </main>
            ...
            <section className="mt-6 flex flex-col items-center">
              ...
              >
                {loading ? (
                  ...
                  <span className="inline-flex items-center gap-2 font-poppins">
              ...
              <div className="mt-4 flex w-full items-center gap-3">
                ...
                <Button
                  ...
                  disabled={loading || !barcode || inflightRef.current}
                  className="font-poppins h-12 rounded-2xl px-5 font-semibold border-[#9334eb] text-[#9334eb] hover:bg-[#9334eb]/5 disabled:opacity-60"
                >
                  Cek
                </Button>
              </div>
              <p className="mt-3 text-center text-[13px] leading-5 text-neutral-500 font-grotesk">
